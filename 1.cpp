...
int lab2_init() {
    ...
    // Переход по интервалам
    sleep(1); next_interval();  // к интервалу 2
    sleep(1); next_interval();  // к 3
    sleep(1); next_interval();  // к 4
    sleep(1); next_interval();  // к 5
    sleep(1); next_interval();  // к 6
